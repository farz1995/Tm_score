...
class Aligning(object):
    ...
    def optimise(self, restart=True):
        ...
        def objective(params):
            theta, phi, psi, dx, dy, dz = params
            return self(theta, phi, psi, dx, dy, dz)

        # Initial guess
        initial_guess = [default['theta'], default['phi'], default['psi'],
                         default['dx'], default['dy'], default['dz']]
        ...
        # print(f"Optimized TM-score: {tm_score}")
        # print(f"Optimized RMSD: {rmsd_value}")

        return _values, tm_score, rmsd_value
